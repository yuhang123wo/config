...
import cn.yh.user.config.annotation.SecurityParameter;
 ...
 * @desc
 */
@ControllerAdvice("cn.yh.user.controller")
	...
	class MyHttpInputMessage implements HttpInputMessage {
		...
		public MyHttpInputMessage(HttpInputMessage inputMessage) throws Exception {
			...
			this.body = IOUtils.toInputStream(
					AesEncryptUtils.decrypt(easpString(IOUtils.toString(inputMessage.getBody(), "UTF-8"))), "UTF-8");
		}
